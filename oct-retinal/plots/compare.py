# ============================================================
# plots/compare.py  —  OCT FL Benchmark (repeat-aware)
...
def plot_learning_curves(all_results, show=False):
    ...
    fig.suptitle(
        "OCT 4-Class FL — Global Test Metrics\n"
...
def plot_confusion_matrices(all_results, show=False):
    ...
    for idx, run_name in enumerate(run_names):
        ...
        for rep in all_results[run_name]:
            last = rep["rounds"][-1]
            cm   = np.array(last.get("conf_matrix",
                                     [[0]*4]*4))
...
def plot_per_class_accuracy(all_results, show=False):
    """Per-class accuracy from confusion matrix, averaged across repeats."""
    run_names = [r[0] for r in RUNS if r[0] in all_results]
...
if __name__ == "__main__":
    ...
    print()
    print("  OCT Benchmark — Generating Plots")
    print("  " + "─" * 50)
    print()
