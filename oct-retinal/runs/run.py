# ============================================================
# runs/run.py
# Main orchestrator for OCT FL benchmark.
# ============================================================
...
def build_train_job(run_name: str, use_gs: bool, start_round: int) -> Path:
    ...
    server_cfg = {
        ...
        "workflows": [{
            ...
            "args": {
                "run_name"        : run_name,
                "test_images_path": str(gs_out_dir(run_name) / "test" / "images.npy")
                                    if use_gs else str(TEST_DIR / "images.npy"),
                "test_labels_path": str(TEST_DIR / "labels.npy"),
                "ckpt_dir"        : str(ckpt),
